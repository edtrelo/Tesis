...
\usepackage{siunitx}
\sisetup{
  output-decimal-marker = {.}, % punto para decimales
  group-separator = {,},       % coma para separar miles
  group-minimum-digits = 4,     % empieza a separar desde 1000,
  round-mode = places,
  round-precision = 2
}
...
\label{cap:03}
\input{capitulos/cap03/_main_.tex}

\chapter{Aplicaciones a modelos epidemiológicos compartamentales}
\label{cap:04}
\input{capitulos/cap04/_main_.tex}
